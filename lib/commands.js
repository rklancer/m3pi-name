(function() {
  var HALF_SPEED_ROTATION_RATE, HALF_SPEED_TRANSLATION_RATE, ROTATION_RATE, ROTATION_SPEED_FRACTION, TRANSLATION_RATE, TRANSLATION_SPEED_FRACTION, back, degrees, forward, issueCommandsFor, left, limit, pseudoGauss, right, rotationWait, round, translationWait, type, vertices;
  ...
  issueCommandsFor = function(vertices) {
    var dtheta, dx, dy, factor, goleft, goright, r, theta, theta1, vertex, x, x1, y, y1, _i, _len, _ref, _ref2, _ref3, _ref4, _results;
    ...
    for (_i = 0, _len = _ref2.length; _i < _len; _i++) {
      ...
      goleft = function(angle) {
        if (angle > 0.001) {
          ...
          return left(angle * (1 + pseudoGauss() / 3));
        }
      };
      goright = function(angle) {
        if (angle > 0.001) {
          theta = limit(theta - angle);
          return right(angle * (1 + pseudoGauss() / 3));
        }
      };
